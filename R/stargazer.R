stargazer <-
function(..., type = "latex", title="", style="default", summary=TRUE, out=NULL, column.labels=NULL, column.separate = NULL, covariate.labels=NULL, dep.var.caption=NULL, dep.var.labels=NULL, dep.var.labels.include=TRUE, align=FALSE, coef=NULL, se=NULL, t=NULL, p=NULL,  t.auto=TRUE, p.auto=TRUE, ci=FALSE, ci.level=0.95, ci.separator=NULL, column.sep.width = "5pt", decimal.mark=NULL, digit.separate=NULL, digit.separator=NULL, digits=NULL, digits.extra=NULL, float=TRUE, float.env="table", font.size=NULL, header=TRUE, initial.zero=NULL, intercept.top=NULL, label="", model.names=NULL, model.numbers=NULL, no.space=NULL, notes=NULL, notes.align=NULL, notes.append=TRUE, notes.label=NULL, omit=NULL, omit.labels=NULL, omit.stat=NULL, omit.yes.no=c("Yes","No"), ord.intercepts=FALSE, perl=FALSE, rq.se = "nid", single.row=FALSE, star.char=NULL, star.cutoffs=NULL, suppress.errors=FALSE, table.placement = "!htbp", zero.component=FALSE, summary.logical=TRUE, nobs=TRUE, mean.sd=TRUE, min.max=TRUE, median=FALSE, iqr=FALSE) {
  ...
  return(.stargazer.wrap(..., type=type, title=title, style=style, summary=summary, out=out,
                         ...
                         ci=ci, ci.level=ci.level, ci.separator = ci.separator,
                         ...
                         initial.zero=initial.zero, intercept.top=intercept.top, label = label,
                         ...
                         ord.intercepts=ord.intercepts, perl=perl, rq.se=rq.se,
