stargazer <-
function(..., title="", style="default", summary=TRUE, covariate.labels=NULL, dep.var.labels=NULL, align=FALSE, decimal.mark=NULL, digit.separate=NULL, digit.separator=NULL, digits=NULL, digits.extra=NULL, initial.zero=NULL, intercept.top=NULL, model.names=NULL, model.numbers=NULL, notes=NULL, notes.align=NULL, notes.label=NULL, omit=NULL, omit.labels=NULL, omit.stat=NULL, omit.yes.no=c("Yes","No"), ord.intercepts=FALSE, star.char=NULL, star.cutoffs=NULL, zero.component=FALSE, nobs=TRUE, mean.sd=TRUE, min.max=TRUE, median=FALSE, iqr=FALSE) {
  return(.stargazer.wrap(..., title=title, style=style, summary=summary, covariate.labels=covariate.labels, 
                         dep.var.labels=dep.var.labels, align=align, decimal.mark=decimal.mark,
